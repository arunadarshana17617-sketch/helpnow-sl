...
export default function BookingModal({ provider, service, onClose }) {
  ...
  const [step, setStep] = useState(1); // 1=login check, 2=customer details, 3=job details, 4=success
  ...
  // Login check - session na nam login page ekata
  if (status === 'loading') {
    return (
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
          ...
          <div className="text-center py-4">
            ...
            <p className="text-gray-600 mb-6">
              Booking ekak karanna mulinma Google account ekata login karanna one.
            </p>
            <button
        ...
        <div className="flex items-center px-6 pt-4">
          {[
            ...
            <React.Fragment key={s.n}>
              ...
              {idx < 2 && <div className={`flex-1 h-0.5 mx-2 ${step > s.n ? 'bg-green-500' : 'bg-gray-200'}`} />}
            </React.Fragment>
          ))}
        </div>
        ...
        {step === 2 && (
          <form onSubmit={handleCustomerNext} className="p-6 space-y-4">
            ...
            <div>
              ...
              <select value={customerData.district}
            ...
            <div>
              ...
              <input type="text" value={customerData.city}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea value={customerData.address}
        ...
        {step === 3 && (
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="date" value={jobData.preferredDate}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="number" value={jobData.estimatedDays} min="1" max="30"
            ...
            <div>
              ...
              <textarea value={jobData.customerNotes}
